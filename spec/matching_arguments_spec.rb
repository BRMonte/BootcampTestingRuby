RSpec.describe "matching arguments" do
  it "can return different values depending on the argument" do
    ...
    allow(three_element_array).to receive(:first).with(be >= 3).and_return([1, 2, 3]) #this lines says: allow my object to receive the .first method and if the arguments is 3 or bigger, return [1,2,3]
